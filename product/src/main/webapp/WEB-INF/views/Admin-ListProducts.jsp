...
<option value="">Select-Sorting Type</option>
 <option value="sortingLowToHigh">Low To High</option>
 
 <option value="sortingHighToLow">High To Low</option>

</select>  &emsp;&emsp;&emsp;&emsp;&emsp;
</form>
		<form class= "mx-2 my-auto w-full" action="RedirectToAddProductServlet" method="POST">
												<input id="prodId" name="userName" type="hidden" value=${user.userName}>   
                                                       <a href="Admin-AddProduct12.html" class="btn btn-dark form-rounded" >Add Product</a>
					</form>
<form>
                        </div>
                                     ...
                                     <table border="1" class="table table-bordered">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                            <center><span style="color: gray">Quantity</span>
                                                        </td>
                                                        <td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span style="color: gray">${product.productPrice}
                            </span>
                          </td>
                          <td>
                            <center>
                              <a href="Admin-ViewProduct.html?id=${product.productId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;View&emsp; 
                              </a>&emsp;&emsp;
								<input id="productId" name="userName" type="hidden" value=${user.userName}>
                             
                              <a  href="AdminDeleteProduct.html?id=${product.productId }" class="btn btn-secondary form-rounded">&nbsp;Remove&nbsp; 
                              </a>
                            </center>
                          </td>
                        </tr>
