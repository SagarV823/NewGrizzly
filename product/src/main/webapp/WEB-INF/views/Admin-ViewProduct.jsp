                ...
                <div class="col-md-6 bg-light">
                    ...
                    <div class="btn-group col-md-12">
                        ...
                        <div class="col-md-8 bg-light">
                                <span>${product.productName}  </b></span><span class="fa fa-pencil-square" aria-hidden="true"></span>
                        ...
                        <div class="col-md-4 bg-light"> 
                                     <br>  <br> <br>          <br>                      
        <span style="color: gray">PRODUCT NAME : ${product.productName}</span><span class="fa fa-pencil-square" aria-hidden="true"></span>
        <br>
        <span style="color: gray">PRODUCT PRICE : ${product.productPrice}</span><span class="fa fa-pencil-square" aria-hidden="true"></span>
        <br>
        <span style="color: gray">PRODUTC QUANTITY : ${product.productQuantity}</span><span class="fa fa-pencil-square" aria-hidden="true"></span>
...
<div class="col-md-3">
    <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            ...
            <a href="Admin-ListProducts.html">
   		<button>Finish</button>
			</a>

      <!--       <button>
            <a href ="Admin-ListProducts.html" class="btn btn-secondary form-rounded" type="submit">Finish</a></button><br><br> -->
